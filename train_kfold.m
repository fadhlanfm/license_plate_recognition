function [TrainingTime,TrainingAccuracy] = train_kfold(Elm_Type,jml_hidden_neuron,ActivationFunction)
...
% NumberofHiddenNeurons - Number of hidden neurons assigned to the ELM=378
...
NumberofHiddenNeurons=jml_hidden_neuron;
...
if Elm_Type~=REGRESSION
    save('elm_kfold', 'NumberofInputNeurons', 'NumberofOutputNeurons', 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'label', 'Elm_Type');
else
    save('elm_kfold', 'InputWeight', 'BiasofHiddenNeurons', 'OutputWeight', 'ActivationFunction', 'Elm_Type');    
end